...
class GenAllSequencesTest(unittest.TestCase):
    ...
    def test_gen_all_sequences_length_one(self):
        ...
        """
        yahtzee = YahtzeePsychicRecursion()
...
class ExpectedValueTest(unittest.TestCase):
    ...
    def test_expected_value(self):
        ...
        self.assertEqual(yahtzee.expected_value((), 6, 1), 3.5)
...
class RecursiveGenHoldsTest(unittest.TestCase):
    ...
    def test_recursive_gen_holds(self):
        ...
        holds = set([()])
        self.assertEqual(yahtzee.recursive_generate_holds([1], 1, holds), set([(), (1, )]))
        holds = set([()])
        self.assertEqual(yahtzee.recursive_generate_holds([0, 1, 2], 3, holds), 
                                              set([(), (0, ), (1, ), (2, ),
                                                  (0, 1), (0, 2), (1, 2),
                                                  (0, 1, 2)]))
        holds = set([()])
        self.assertEqual(yahtzee.recursive_generate_holds([0, 2, 2, 3], 4, holds),
                                             set([(), (0, ), (2, ), (3, ),
                                                 (0, 2), (0, 3), (2, 2), 
                                                 (2, 3), (0, 2, 3), (0, 2, 2),
                                                 (2, 2, 3), (0, 2, 2, 3)]))
        holds = set([()])
        self.assertEqual(yahtzee.recursive_generate_holds([0, 2, 2, 3, 3], 5, holds), 
                                            set([(0, 3, 3), (0,), (0, 2, 3, 3),
                                                (2, 2, 3), (2,), (2, 2, 3, 3), 
                                                (3,), (0, 2, 2), (0, 2, 3), (),
                                                (2, 3), (2, 3, 3), (2, 2), 
...
class AddSortedHoldToSetTest(unittest.TestCase):
    ...
    def test_add_sorted_hold_to_set(self):
        ...
        temp_set = set()
        self.assertEqual(yahtzee.add_sorted_hold_to_set(temp_set, (1, 2, 5), 5), set([(1, 2, 5), (1, 2, 5, 5)]))
        self.assertEqual(yahtzee.add_sorted_hold_to_set(temp_set, (2, 3, 4), 6), set([(1, 2, 5), (1, 2, 5, 5),
                                                                       (2, 3, 4), (2, 3, 4, 6)]))
...
class UpdateHoldsTest(unittest.TestCase):
    ...
    def test_update_hold(self):
        ...
        temp_set = set()
        self.assertEqual(yahtzee.update_holds(temp_set, (1, 2), (1, 1, 2, 3)), set([(1, 2), (1, 2, 3), (1, 1, 2)]))
        temp_set = set()
        self.assertEqual(yahtzee.update_holds(temp_set, (1, 2, 5), (1, 2, 3, 4, 5)), set([(1, 2, 5), (1, 2, 3, 5), (1, 2, 4, 5)]))
...
class GeneratePartialHoldsTest(unittest.TestCase):
    ...
    def test_generate_partial_holds_with_empty_set(self):
        ...
        holds = set([()])
        self.assertEqual(yahtzee.generate_temp_holds((3, 4, 7), holds), set([(), (3, ), (4, ), (7, )]))
    ...
    def test_generate_partial_holds_with_non_empty_set(self):
        ...
        self.assertEqual(yahtzee.generate_temp_holds((1, 2, 3, 4, 5), holds), 
...
class GenerateSortedHoldTest(unittest.TestCase):
    ...
    def test_generate_sorted_hold_with_empty_hold(self):
        ...
        self.assertEqual(yahtzee.generate_sorted_hold((), 3), (3, ))
    ...
    def test_generate_sorted_hold_with_non_empty_hold(self):
        ...
        self.assertEqual(yahtzee.generate_sorted_hold((1, 5, 3), 2), (1, 2, 3, 5))
        self.assertEqual(yahtzee.generate_sorted_hold((3, 6, 7, 1, 5, 2), 3), (1, 2, 3, 3, 5, 6, 7)) 
...
class RecursiveUpdateSetTest(unittest.TestCase):
    ...
    def test_recursive_update_set(self):
        ...
        temp_set = set()
        self.assertEqual(yahtzee.recursive_update_set(temp_set, (1, 2), [3, 2]), set([(1, 2, 3), (1, 2, 2)]))
        temp_set = set([(1, 2, 5), (1, 2, 3, 5), (1, 2, 4, 5)])
        self.assertEqual(yahtzee.recursive_update_set(temp_set, (1, 2, 4, 5), [3, 1]), 
...
class RecursiveGenerateSequencesTest(unittest.TestCase):
    ...
    def test_recursive_generate_sequences_without_outcomes(self):
        ...
        sequences = set([()])
        self.assertEqual(yahtzee.recursive_generate_sequences([], 0, sequences), set([()]))
    ...
    def test_recursive_generate_sequences(self):
        ...
        length = 1
        sequences = set([()])
        self.assertEqual(yahtzee.recursive_generate_sequences(outcomes, length, sequences), 
                         set([(1, ), (2, ), (3, )]))
        outcomes = [1, 2, 3]
        length = 2
        sequences = set([()])
