...
class TicTacToeBoard(object):
    ...
    def get_empty_squares(self):
        ...
        return self.convert_grid_to_list(index_grid)

    def convert_grid_to_list(self, index_grid):
        """
    ...
    def evaluate_win_status(self):
        ...
        winning_moves = {
            ...
            "uleft_diagonal": self.evaluate_diagonal_win(self.uleft_bright()),
            "bleft_diagonal": self.evaluate_diagonal_win(self.bleft_uright())
        }
